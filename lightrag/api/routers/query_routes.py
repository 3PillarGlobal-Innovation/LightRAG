...
class TokenUsageResponse(BaseModel):
    prompt_tokens: int = Field(
        default=0, description="Number of input tokens sent to the LLM"
    )
    completion_tokens: int = Field(
        default=0, description="Number of output tokens generated by the LLM"
    )
    total_tokens: int = Field(
        default=0, description="Total tokens (prompt + completion)"
    )
    call_count: int = Field(
        default=0, description="Number of LLM calls made for this query"
    )
