...
async def use_llm_func_with_cache(
    ...
    # per-async-task contextvar set by the per-document pipeline task (see
    # lightrag.pipeline.process_document). This is what makes per-doc
    # LLM-usage attribution work under MAX_PARALLEL_INSERT > 1 without
    # anyone having to thread the tracker through the call site.
